(function(ext){
  ...
  ext.acce = function(ip,callback) {
    ...
    $.ajax({
          url:'http://'+ipv+':1880/acce?callback=acce',
          type:'get',
          timeout:5000,
          cache:false,
          dataType:'jsonp',
  ...
  ext.megn = function(ip,callback) {
    ...
    $.ajax({
          url:'http://'+ipv+':1880/megn?callback=megn',
          type:'get',
          timeout:5000,
          cache:false,
          dataType:'jsonp',
  ...
  ext.gyro = function(ip,callback) {
    ...
    $.ajax({
          url:'http://'+ipv+':1880/gyro?callback=gyro',
          type:'get',
          timeout:5000,
          cache:false,
          dataType:'jsonp',
  ...
  ext.distance = function(ip, callback) {
    ...
    $.ajax({
            url:'http://'+ipv+':1880/distance.json',
            dataType:'jsonp',
